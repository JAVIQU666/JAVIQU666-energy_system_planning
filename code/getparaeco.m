function [A,T,c,h] =getpara(E_Load,H_Load,C_Load,PV,WT) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Price_gas = 0.4588; 
omiga = 0.3;
% for i=1:23
...
Constraints = [];
Constraints = [Constraints, Pgird + Pchp*CHPeffg2e' - Pashp*[1 1]' - Pghp*[1 1]' - Peb*[1 1]' - Pec*[1 1]' +  Ppv*PVeff' + Pwt*WTeff' + Edis - Ech == E_Load - Eloss];

Constraints = [Constraints, Pchp*CHPeffg2h' + Pashp*ASHPeff' + Pghp*GHPeff' + Peb*EBeff' + Pgb*GBeff' - Pac*[1 1]' + Hdis - Hch == H_Load - Hloss];

Constraints = [Constraints, Pec*ECeff' + Pac*ACeff' + Cdis - Cch == C_Load - Closs];
...
Objective = Price_ele*Pgird + sum(Price_gas*Pgas) + sum(Pchp*CHPmain') + sum(Pashp*ASHPmain') + sum(Pghp*GHPmain') + ...
           ...
           sum(Eloss*700) + sum(Hloss*800) + sum(Closs*700);
